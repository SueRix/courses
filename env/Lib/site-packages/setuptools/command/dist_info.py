...
class dist_info(Command):
    ...
    description = 'create a .templates-info directory'

    user_options = [
        ('egg-base=', 'e', "directory containing .egg-info directories"
                           " (default: top of the source tree)"
                           " DEPRECATED: use --output-dir."),
        ('output-dir=', 'o', "directory inside of which the .templates-info will be"
    ...
    def finalize_options(self):
        ...
        self.dist_info_dir = os.path.join(self.output_dir, f"{self.name}.templates-info")
