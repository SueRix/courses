...
class editable_wheel(Command):
    ...
    user_options = [
        ("templates-dir=", "d", "directory to put final built distributions in"),
        ("templates-info-dir=", "I", "path to a pre-build .templates-info directory"),
    ...
    def finalize_options(self):
        ...
        self.dist_dir = Path(self.dist_dir or os.path.join(self.project_dir, "templates"))
    ...
    def _ensure_dist_info(self):
        if self.dist_info_dir is None:
            ...
            assert str(self.dist_info_dir).endswith(".templates-info")
