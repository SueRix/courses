...
class Distribution(_Distribution):
    ...
    This is an enhanced version of 'distutils.templates.Distribution' that
    ...
    def _parse_config_files(self, filenames=None):  # noqa: C901
        """
        Adapted from distutils.templates.Distribution.parse_config_files,
    ...
    def _set_command_options(self, command_obj, option_dict=None):  # noqa: C901
        ...
        (Adopted from distutils.templates.Distribution._set_command_options)
        """
    ...
    def include(self, **attrs):
        ...
        For example, 'templates.include(py_modules=["x"])' would add 'x' to
        ...
        the value passed to 'include()'.  So, 'templates.include(foo={"bar":"baz"})'
        will try to call 'templates._include_foo({"bar":"baz"})', which can then
    ...
    def exclude(self, **attrs):
        ...
        For example, 'templates.exclude(py_modules=["x"])' would remove 'x' from
        ...
        where 'X' is the name of the attribute.  The method will be called with
        the value passed to 'exclude()'.  So, 'templates.exclude(foo={"bar":"baz"})'
        will try to call 'templates._exclude_foo({"bar":"baz"})', which can then
...
class DistDeprecationWarning(SetuptoolsDeprecationWarning):
    """Class for warning about deprecations in templates in
