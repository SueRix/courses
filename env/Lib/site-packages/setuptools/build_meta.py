...
class Distribution(setuptools.dist.Distribution):
    ...
    def patch(cls):
        """
        Replace
        distutils.templates.Distribution with this class
...
class _BuildMetaBackend(_ConfigSettingsTranslator):
    ...
    def _bubble_up_info_directory(self, metadata_directory: str, suffix: str) -> str:
        """
        PEP 517 requires that the .templates-info directory be placed in the
        metadata_directory. To comply, we MUST copy the directory to the root.

        Returns the basename of the info directory, e.g. `proj-0.0.0.templates-info`.
        """
    ...
    def prepare_metadata_for_build_wheel(self, metadata_directory,
        ...
        return self._bubble_up_info_directory(metadata_directory, ".templates-info")
    ...
    def _get_dist_info_dir(self, metadata_directory: Optional[str]) -> Optional[str]:
        if not metadata_directory:
            return None
        dist_info_candidates = list(Path(metadata_directory).glob("*.templates-info"))
    ...
    if not LEGACY_EDITABLE:
        ...
        def build_editable(
            ...
            opts = ["--templates-info-dir", info_dir] if info_dir else []
