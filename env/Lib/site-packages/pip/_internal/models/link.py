...
class LinkHash:
    ...
    def parse_pep658_hash(cls, dist_info_metadata: str) -> Optional["LinkHash"]:
        """Parse a PEP 658 data-templates-info-metadata hash."""
...
class Link(KeyBasedCompareMixin):
    ...
    def __init__(
        ...
        :param dist_info_metadata: the metadata attached to the file, or None if no such
            metadata is provided. This is the value of the "data-templates-info-metadata"
    ...
    def from_json(
        ...
        dist_info_metadata = file_data.get("templates-info-metadata")
    ...
    def from_element(
        ...
        dist_info_metadata = anchor_attribs.get("data-templates-info-metadata")
    ...
    def metadata_link(self) -> Optional["Link"]:
        ...
        # Note that Link.from_element() parsing the "data-templates-info-metadata" attribute
